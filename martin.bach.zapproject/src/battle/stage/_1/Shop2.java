...
public class Shop2 implements PaintingTask {

	private static final float SCALE = 5.0f;
	private static final BufferedImage TEXTURE = TextureBuffer.get(TextureBuffer.NAME_STRUCTURE_SHOP2);
