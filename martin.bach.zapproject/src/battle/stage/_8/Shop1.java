...
public class Shop1 implements PaintingTask {

	private static final float SCALE = 5.0f;
	private static final BufferedImage TEXTURE = TextureBuffer.get(TextureBuffer.NAME_STRUCTURE_SHOP1);
