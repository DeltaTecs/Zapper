...
public class FriendGamma1 extends Enemy {
	...
	private static final int TAIL_DISTANCE = 9;
	private static final float TAIL_SIZEREMOVAL = 0.9f;
	private static final int[] TAIL_POS_X = new int[] {26, -26};
	private static final int[] TAIL_POS_Y = new int[] {140, 140};
	...
	public FriendGamma1() {
		super(0, 0, SPEED, TEXTURE, SCALE, COLINFO, new AdvancedSingleProtocol(),
				...
				PROJECTILE_RANGE, CRYSTALS, FRIEND, new TailManager(TAIL_SIZE, TAIL_DISTANCE, TAIL_SIZEREMOVAL, TAIL_POS_X, TAIL_POS_Y, TAIL_SQUARE));
		setBackground(true);
