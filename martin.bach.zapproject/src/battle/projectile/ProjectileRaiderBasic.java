...
public class ProjectileRaiderBasic extends Projectile {
	...
	private static final Color COLOR = new Color(170, 7, 7);
	private static final boolean SQUARE = false;

	public ProjectileRaiderBasic() {
		super(COLINFO, SPEED, (int) RADIUS, SQUARE, COLOR, DAMAGE);
	}

	@Override
	public Object getClone() {
		return new ProjectileRaiderBasic();
	}
